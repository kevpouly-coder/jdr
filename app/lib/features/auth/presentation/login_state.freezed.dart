...
class _$LoginStateImpl extends _LoginState {
  const _$LoginStateImpl({this.email = '', this.password = '', this.isLoading = false}) : super._();
...
abstract class _LoginState extends LoginState {
  const factory _LoginState({final String email, final String password, final bool isLoading}) = _$LoginStateImpl;
